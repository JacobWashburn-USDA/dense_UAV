...
df[1:5,1:5]
df_sub <- dplyr::select(df, -contains("Height"))
...
df_sub <- dplyr::select(df, -contains( c("Height", "126") ))
P42 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P42,"P42.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122") ))
P41 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P41,"P41.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118") ))
P40 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P40,"P40.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114") ))
P39 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P39,"P39.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111") ))
P38 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P38,"P38.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107") ))
P37 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P37,"P37.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104") ))
P36 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P36,"P36.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101") ))
P35 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P35,"P35.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99") ))
P34 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P34,"P34.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99","96"  ) ))
P33 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P33,"P33.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99","96","93"  ) ))
P32 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P32,"P32.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99","96","93","90"  ) ))
P31 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P31,"P31.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99","96","93","90","87" ) ))
P30 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P30,"P30.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99","96","93","90","87" ,"85" ) ))
P29 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P29,"P29.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99","96","93","90","87" ,"85","83") ))
P28 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P28,"P28.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99","96","93","90","87" ,"85","83","80"  ) ))
P27 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P27,"P27.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99","96","93","90","87" ,"85","83","80","78"  ) ))
P26 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P26,"P26.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99","96","93","90","87" ,"85","83","80","78","76"  ) ))
P25 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P25,"P25.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99","96","93","90","87" ,"85","83","80","78","76" ,"73"  ) ))
P24 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P24,"P24.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99","96","93","90","87" ,"85","83","80","78","76" ,"73" ,"71"  ) ))
P23 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P23,"P23.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99","96","93","90","87" ,"85","83","80","78","76" ,"73" ,"71","69" ) ))
P22 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P22,"P22.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99","96","93","90","87" ,"85","83","80","78","76" ,"73" ,"71","69","66"  ) ))
P21 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P21,"P21.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99","96","93","90","87" ,"85","83","80","78","76" ,"73" ,"71","69","66","64" ) ))
P20 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P20,"P20.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99","96","93","90","87" ,"85","83","80","78","76" ,"73" ,"71","69","66","64","62"  ) ))
P19 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P19,"P19.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99","96","93","90","87" ,"85","83","80","78","76" ,"73" ,"71","69","66","64","62","60"  ) ))
P18 <- tcrossprod(as.matrix(df_sub))/ncol(as.matrix(df_sub))
write.csv(P18,"P18.csv")

df_sub <- dplyr::select(df, -contains( c("Height", "126", "122", "118" ,"114", "111", "107", "104", "101","99","96","93","90","87" ,"85","83","80","78","76" ,"73" ,"71","69","66","64","62","60","56"   ) ))
...
library(readr)
list_csv_files <- list.files(path = "D:\\Washburn\\Prediction new\\Pred ability")
...
write.csv(df,"Prediction ability.csv")
library(ggplot2)
...
jpeg("D:\\Washburn\\Prediction new\\Pred ability\\Pred_Yield.jpeg", 
